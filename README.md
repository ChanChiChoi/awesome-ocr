...
- 【CTPN】Tian Z, Huang W, He T, et al. [Detecting text in natural image with connectionist text proposal network](https://arxiv.org/pdf/1609.03605)[C]//European Conference on Computer Vision. Springer International Publishing, 2016: 56-72.<br>
    &nbsp;&nbsp;&nbs;p&nbsp; **code**:[[code](https://github.com/eragonruan/text-detection-ctpn);[cuda8-caffe](https://github.com/qingswu/CTPN);[offical](https://github.com/tianzhi0549/CTPN);[ocr_detection_ctpn](https://github.com/Li-Ming-Fan/OCR-DETECTION-CTPN);[keras_ocr](https://github.com/littleredhat1997/OCR-IDCard)]<br>
